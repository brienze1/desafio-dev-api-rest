# language: pt
@SaqueDeContaTest
Funcionalidade: Teste de saque de conta

	O sistema deve realizar o saque da conta de forma correta seguindo as seguintes restricoes:
	1-) Deve ser informado um id_conta valido.
	2-) A conta que vai receber o saque deve estar ativa.
	...
	Cenario: Saque realizado com sucesso
		...
		E que foi  feita a solicitacao de deposito de 300.0 reais para o id_conta reservado
	...
	Cenario: Saque nao realizado valor menor que zero
		Dado que foi cadastrada a seguinte pessoa anteriormente no sistema
		|	nome			|	Jhon Doe	|
		|	cpf				|	12345678912	|
		|	data_nascimento	|	25/01/1995	|
	...
	Cenario: Saque nao realizado valor igual a zero
		Dado que foi cadastrada a seguinte pessoa anteriormente no sistema
		|	nome			|	Jhon Doe	|
		|	cpf				|	12345678912	|
		|	data_nascimento	|	25/01/1995	|
	...
	Cenario: Saque nao realizado saldo insuficiente
		Dado que foi cadastrada a seguinte pessoa anteriormente no sistema
		|	nome			|	Jhon Doe	|
		|	cpf				|	12345678912	|
		|	data_nascimento	|	25/01/1995	|
		...
		|	tipo_conta			|	1	|
		E o "id_conta" que foi gerado tenha sido guardado
		Quando for solicitado o "saque" de 100.0 reais para o id_conta reservado
		Entao deve ser retornado um erro com a seguinte mensagem "saldo insuficiente"
		E o status da chamada retornado deve ser 500

	Cenario: Saque nao realizado conta bloqueada
		Dado que foi cadastrada a seguinte pessoa anteriormente no sistema
		|	nome			|	Jhon Doe	|
		|	cpf				|	12345678912	|
		|	data_nascimento	|	25/01/1995	|
